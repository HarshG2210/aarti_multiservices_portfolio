  ...
  return (
    <Box maxW="7xl" mx="auto" p={4}>
      <VStack spacing={6} align="flex-start">
        ...
        <UnorderedList spacing={3} mb={4}>
          <ListItem>
            <Text as="strong">With Service Providers:</Text> We may share Your
            personal information with Service Providers to monitor and analyze
            the use of our Service, and to contact You.
          </ListItem>

          <ListItem>
            <Text as="strong">For business transfers:</Text> We may share or
          ...
          <ListItem>
            <Text as="strong">With Affiliates:</Text> We may share Your
          ...
          <ListItem>
            <Text as="strong">With business partners:</Text> We may share Your
            information with Our business partners to offer You certain
            products, services, or promotions.
          </ListItem>

          <ListItem>
            <Text as="strong">With other users:</Text> When You share personal
          ...
          <ListItem>
            <Text as="strong">With Your consent:</Text> We may disclose Your
        ...
        <UnorderedList spacing={3} mb={4}>
          <ListItem>
            <Text as="strong">Business Transactions:</Text> If the Company is
          ...
          <ListItem>
            <Text as="strong">Law enforcement:</Text> Under certain
        ...
        <List spacing={3} pl={4}>
          <ListItem>
            Email:{" "}
            <Link href="mailto:support@aartimultiservices.com" color={"blue"}>
          ...
          <ListItem>
            Website:{" "}
            <Link
              href="https://www.aartimultiservices.com/contact"
              color={"blue"}
            >
